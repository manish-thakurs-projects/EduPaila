...
import { FaGraduationCap, FaBookOpen, FaRocket, FaMoon, FaSun } from 'react-icons/fa';
...
export default function About() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-gray-900 dark:to-gray-800 py-10">
          ...
          <div className="px-8 py-12 md:px-16 md:py-20">
            ...
            <div className="space-y-8 text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              <AnimatedParagraph delay="0.5s">
                At <strong className="text-blue-600 dark:text-blue-400">EduPaila</strong>, we're revolutionizing engineering entrance preparation. Our platform combines cutting-edge technology with proven educational strategies to create a learning experience that's both effective and engaging.
              </AnimatedParagraph>

              <AnimatedParagraph delay="1s">
                With personalized study plans, interactive video lessons, and real-time performance analytics, we help students identify their strengths and target areas for improvement. Our mock tests simulate actual exam conditions, ensuring you're fully prepared when the big day arrives.
              </AnimatedParagraph>

              <AnimatedParagraph delay="1.5s">
                Join a community of ambitious learners who've achieved an average 92% success rate in entrance exams. Whether you're aiming for top ranks in IOE or excelling in NEB courses, we're here to support every step of your journey.
              </AnimatedParagraph>
            </div>
            ...
            <div className="mt-16 flex justify-center">
              <Link 
                to="/joinus" 
                className="bg-gradient-to-r from-blue-500 to-indigo-600 dark:from-blue-600 dark:to-indigo-700 text-white px-8 py-4 rounded-full text-lg font-semibold shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 flex items-center gap-2"
              >
