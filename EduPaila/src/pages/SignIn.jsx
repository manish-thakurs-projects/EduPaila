...
export default function SignIn() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!agreeToTerms) {
      return dispatch(
        signInFailure("You must agree to the Terms and Conditions")
      );
    }
    try {
      ...
      <div className="signIn-wrapper">
        <div className="signIn-left">
          ...
          <p className="signIn-description">
            Welcome to EduPaila! Unlock your learning potential with
            expert-curated courses and a supportive community. Learn at your own
            pace, anytime, anywhere. Start your journey with us today!
          </p>
        </div>
