...
const VideoPage = () => {
  ...
  const cleanDescription = video?.description
    ? video.description.replace(/<p><br><\/p>/g, "").trim()
    : "";
    ...
    <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
      ...
      <div className="bg-gray-300 dark:bg-slate-900 p-4 rounded-lg">
        ...
        <p
          ...
          dangerouslySetInnerHTML={{
            __html:
              cleanDescription || "No description available at the moment.",
          }}
        />
      ...
      {isReportOpen && (
        <div className="fixed inset-0 flex items-center justify-center bg-black/50">
          <div
            ref={reportPopupRef}
            className="bg-slate-200 dark:bg-slate-900 rounded-lg p-6 max-w-sm w-4/5"
          >
